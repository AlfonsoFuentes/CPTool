...
namespace CPTool.Infrastructure.Migrations
{
    ...
    [Migration("20221003102014_brandsupplier")]
    partial class brandsupplier
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CPTool.Domain.Entities.BrandSupplier", b =>
                {
                    b.HasOne("CPTool.Domain.Entities.Brand", null)
                        .WithMany()
                        .HasForeignKey("BrandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CPTool.Domain.Entities.Supplier", null)
                        .WithMany()
