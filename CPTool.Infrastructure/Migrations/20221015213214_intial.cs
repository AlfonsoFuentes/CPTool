        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PipeDiameters_PipeClasss_PipeClassId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProcessFluidEquipmentId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_EquipmentItems_ProcessFluids_ProcessFluidEquipmentId",
                        column: x => x.ProcessFluidEquipmentId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProcessConditionId = table.Column<int>(type: "int", nullable: true),
                    ProcessFluidInstrumentId = table.Column<int>(type: "int", nullable: true),
                    GasketId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_InstrumentItems_ProcessFluids_ProcessFluidInstrumentId",
                        column: x => x.ProcessFluidInstrumentId,
                        principalTable: "ProcessFluids",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseOrderMWOItems", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MaterialId = table.Column<int>(type: "int", nullable: true),
                    ProcessFluidPipingId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PipingItems_ProcessFluids_ProcessFluidPipingId",
                        column: x => x.ProcessFluidPipingId,
                        principalTable: "ProcessFluids",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EquipmentItems_ProcessFluidEquipmentId",
                table: "EquipmentItems",
                column: "ProcessFluidEquipmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstrumentItems_ProcessFluidInstrumentId",
                table: "InstrumentItems",
                column: "ProcessFluidInstrumentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PipeDiameters_PipeClassId",
                table: "PipeDiameters",
                column: "PipeClassId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PipingItems_ProcessFluidPipingId",
                table: "PipingItems",
                column: "ProcessFluidPipingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrderMWOItems_PurchaseOrderId",
