...
{
    public partial class GeneralNov292022 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SignalModifiers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BudgetPrize = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseOrderItems_MWOItems_MWOItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SignalTypeId = table.Column<int>(type: "int", nullable: true),
                    IOType = table.Column<int>(type: "int", nullable: false),
                    SignalModifierId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Signals_SignalModifiers_SignalModifierId",
                        column: x => x.SignalModifierId,
                        principalTable: "SignalModifiers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaksType = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    paMaterialId = table.Column<int>(type: "int", nullable: true),
                    paDiameterId = table.Column<int>(type: "int", nullable: true),
                    paPipeClassId = table.Column<int>(type: "int", nullable: true),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PipeAccesorys_Materials_paMaterialId",
                        column: x => x.paMaterialId,
                        principalTable: "Materials",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PipeAccesorys_PipeClasss_paPipeClassId",
                        column: x => x.paPipeClassId,
                        principalTable: "PipeClasss",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PipeAccesorys_PipeDiameters_paDiameterId",
                        column: x => x.paDiameterId,
                        principalTable: "PipeDiameters",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PipeAccesorys_paDiameterId",
                table: "PipeAccesorys",
                column: "paDiameterId");

            migrationBuilder.CreateIndex(
                name: "IX_PipeAccesorys_paMaterialId",
                table: "PipeAccesorys",
                column: "paMaterialId");

            migrationBuilder.CreateIndex(
                name: "IX_PipeAccesorys_paPipeClassId",
                table: "PipeAccesorys",
                column: "paPipeClassId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrderItems_MWOItemId",
