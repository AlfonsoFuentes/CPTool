...
using CPTool.Application.Features.FieldLocationFeatures.Query.GetList;
...
using CPTool.Application.Features.SignalTypeFeatures.Query.GetList;
...
using CPTool.Application.Features.WireFeatures.Query.GetList;
using MediatR;
...
namespace CPTool.Services
{
    public static class GlobalTables
    {
        ...
        public static List<EditPurchaseOrderItem> PurchaseOrderItems { get; set; } = new();
        ...
        public static List<EditNozzle> Nozzles { get; set; } = new();
        ...
        public static List<EditPipeAccesory> PipeAccesorys { get; set; } = new();
        public static async Task InitializeTables(IMediator Mediator)
        {
            ...
            GetNozzleListQuery getNozzleListQuery = new();
            ...
            PipeAccesorys = await Mediator.Send(getPipeAccesoryListQuery);
            Nozzles =  await Mediator.Send(getNozzleListQuery);
            PurchaseOrderItems = await Mediator.Send(getPurchaseOrderItemListQuery);
        }
