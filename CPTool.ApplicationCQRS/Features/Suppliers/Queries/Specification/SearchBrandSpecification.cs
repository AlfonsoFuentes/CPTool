...
namespace CPTool.ApplicationCQRS.Features.Suppliers.Queries.Specification
{
    public class SearchSupplierSpecification : Specification<Supplier>
    {
        public SearchSupplierSpecification(CommandSupplier query)
        {
            Criteria = q => q.Name != null;
            if (!string.IsNullOrEmpty(query.Name))
            {
                //And(x => x.Name.Contains(query.Keyword) || x.Description.Contains(query.Keyword) || x.Supplier.Contains(query.Keyword));
            }
            //if (!string.IsNullOrEmpty(query.Name))
            //{
            ...
            //{
            //    And(x => x.Supplier == query.Supplier);
            //}
