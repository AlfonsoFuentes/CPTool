...
namespace CPTool.ApplicationCQRS.Features.Brands.Queries.Specification
{
    public class SearchBrandSpecification : Specification<Brand>
    {
        public SearchBrandSpecification(CommandBrand query)
        {
