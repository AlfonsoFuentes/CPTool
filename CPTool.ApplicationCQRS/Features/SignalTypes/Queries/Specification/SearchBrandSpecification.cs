...
namespace CPTool.ApplicationCQRS.Features.SignalTypes.Queries.Specification
{
    public class SearchSignalTypeSpecification : Specification<SignalType>
    {
        public SearchSignalTypeSpecification(CommandSignalType query)
        {
            Criteria = q => q.Name != null;
            if (!string.IsNullOrEmpty(query.Name))
            {
                //And(x => x.Name.Contains(query.Keyword) || x.Description.Contains(query.Keyword) || x.SignalType.Contains(query.Keyword));
            }
            //if (!string.IsNullOrEmpty(query.Name))
            //{
            ...
            //{
            //    And(x => x.SignalType == query.SignalType);
            //}
