...
namespace CPTool.PersistenceCQRS.Migrations
{
    ...
    [Migration("20230104135900_RemoveInternalItems")]
    partial class RemoveInternalItems
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CPTool.Domain.Entities.MWOItem", b =>
                {
                    ...
                    b.HasOne("CPTool.Domain.Entities.EquipmentItem", null)
                        .WithMany("MWOItems")
                    ...
                    b.HasOne("CPTool.Domain.Entities.InstrumentItem", null)
                        .WithMany("MWOItems")
                    ...
                    b.HasOne("CPTool.Domain.Entities.Material", "OuterMaterial")
                    ...
                    b.HasOne("CPTool.Domain.Entities.PipingItem", null)
                        .WithMany("MWOItems")
