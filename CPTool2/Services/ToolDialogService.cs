...
using CPTool2.NewPages.Dialogs.BrandSupplier.Dialog;
using CPTool2.NewPages.Dialogs.Material;
using CPTool2.NewPages.Dialogs.Material.Dialog;
using CPTool2.NewPages.Dialogs.MWO.Dialog;
using CPTool2.NewPages.Dialogs.MWOItem.Dialog;
using CPTool2.NewPages.Dialogs.Nozzle;
using CPTool2.NewPages.Dialogs.Nozzle.Dialog;
using CPTool2.NewPages.Dialogs.PipeDiameter.Dialog;
using CPTool2.NewPages.Dialogs.ProcessFluid.Dialog;
using CPTool2.NewPages.Dialogs.PurchaseOrder.Dialog;
using MudBlazor;
