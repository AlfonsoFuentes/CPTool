...
namespace CPTool.UnitsSystem
{
    public static class PhysicsConstant
    {
        ...
        /// </summary>
        public static readonly Amount NewtonianGravitation = new Amount(6.67384 * Math.Pow(10, -11),
            LengthUnits.Meter.Power(3) / MassUnits.KiloGram / TimeUnits.Second.Power(2));

        /// <summary>
        /// 6.626 069 57 x 10-34 J s
        /// </summary>
        public static readonly Amount Planck = new Amount(6.62606957 * Math.Pow(10, -34),
            EnergyUnits.Joule * TimeUnits.Second);
        ...
        public static readonly Amount GravityAceleration = new Amount(9.81, LengthUnits.Meter / TimeUnits.Second.Power(2));
