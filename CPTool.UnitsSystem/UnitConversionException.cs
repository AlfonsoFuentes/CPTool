...
namespace CPTool.UnitsSystem
{
    ...
    public class UnitConversionException : InvalidOperationException
    {
        ...
        public UnitConversionException(Unit fromUnit, Unit toUnit) : this(String.Format("Failed to convert from unit '{0}' to unit '{1}'. UnitsSystem are not compatible and no conversions are defined.", fromUnit.Name, toUnit.Name)) { }
