...
namespace CPTool.UnitsSystem
{
    ...
    public class UnitManager
    {
        ...
        private Dictionary<string, List<Unit>> unitsByFamily = new Dictionary<string, List<Unit>>();
        ...
        public static void RegisterUnit(Unit unit)
        {
            ...
            {
                Instance.unitsByFamily.Add(unit.Family, new List<Unit>());
            }
        ...
        public static IList<Unit> GetUnitsByFamily(Unit unit)
        {
